...
# execute if score $multiplier janken_multiplier matches 12 run tellraw @a [{"text":"[Janken] ","color":"green"},{"text":"勝利！ 1.2倍ダメージ","color":"yellow"}]
# execute if score $multiplier janken_multiplier matches 8 run tellraw @a [{"text":"[Janken] ","color":"gray"},{"text":"汎用兵士… 0.8倍ダメージ","color":"yellow"}]
# execute if score $multiplier janken_multiplier matches 5 run tellraw @a [{"text":"[Janken] ","color":"red"},{"text":"敗北… 0.5倍ダメージ","color":"yellow"}]
